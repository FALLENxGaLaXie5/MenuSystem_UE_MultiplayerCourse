...
void AMenuSystemCharacter::CreateGameSession()
{
	...
	// Check if a session is already running/destroy if it is
	...
	//Add Create Session delegate to our CreateSession delegate handle
	//	(basically just hooks it onto that list of delegates that are called when the session is then created)
